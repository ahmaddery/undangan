...
use App\Models\MempelaiPriaModel;

class MempelaiPria extends BaseController
{
    public function __construct()
    {
        $this->mempelaiModel = new MempelaiPriaModel();
    }
    ...
    public function index()
    {
        ...
        return view('mempelai_pria/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('mempelai_pria/create');
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('/mempelai_pria');
    }
    ...
    public function edit($id)
    {
        ...
        return view('mempelai_pria/edit', $data);
    }
